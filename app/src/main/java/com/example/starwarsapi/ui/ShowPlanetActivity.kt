...
import kotlinx.android.synthetic.main.item_adapter_list.*
import kotlinx.android.synthetic.main.item_adapter_list.view.*

class ShowPlanetActivity : AppCompatActivity() {
    private val viewModel: ShowPlanetActivityViewModel by viewModel()
    private val adapter = ListAdapter(this, mutableListOf<Planets>()) { planets, view ->
