...
class ShowVehicleActivity : AppCompatActivity() {
    private val viewModel: ShowVehicleActivityViewModel by viewModel()
    private val adapter = ListAdapter(this, mutableListOf<Vehicles>()) { Vehicles, view ->
